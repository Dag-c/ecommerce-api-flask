...
class Config:
    ...
    if dotenv_loaded:
        ...
        SMTP_SERVER = os.getenv("SMTP_SERVER_DEVELOPMENT")
        ORIGIN_MAIL = os.getenv("ORIGIN_MAIL_DEVELOPMENT")
        APP_GMAIL_PASSWORD = os.getenv("APP_GMAIL_PASSWORD_DEVELOPMENT")
    else:
        ...
        SMTP_SERVER = os.getenv("SMTP_SERVER_PRODUCTION")
        ORIGIN_MAIL = os.getenv("ORIGIN_MAIL_PRODUCTION")
        APP_GMAIL_PASSWORD = os.getenv("APP_GMAIL_PASSWORD_PRODUCTION")
